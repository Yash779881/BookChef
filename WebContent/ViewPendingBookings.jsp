...
<title>Pending Bookings | Chef Dashboard</title>
<style>
    body {
        margin: 0;
        ...
        <table class="table table-hover"> 
            ...
            %>
                <tr>  
                    ...
                    <td><%=i.getString(6)%></td>
                    <td><%=i.getString(7)%></td>
                    <td><a href="ApproveBookings.jsp?id=<%=i.getInt(1)%>">Approve</a></td>
                    <td><a href="DisapproveBookings.jsp?id=<%=i.getInt(1)%>">Disapprove</a></td>
                </tr> 
                <% 
                }
            } catch(Exception e) {
